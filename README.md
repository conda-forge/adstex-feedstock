...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adstex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11268&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adstex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `adstex` can be installed with:

```
conda install adstex
```

It is possible to list all of the versions of `adstex` available on your platform with:
